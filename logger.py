class Logger(object):
    ...
    def write_metadata(self, pop_size, vacc_percentage, virus_name, mortality_rate,
        ...
        open_file = open('./logs/' + self.file_name, "w")
    ...
    def log_interaction(self, person1, person2, did_infect=None,
        ...
        with open(self.file_name, "a") as file:
            if did_infect:
                file.write(person1._id + ' has infected' + person2._id + ' \n')
        pass
    ...
    def log_infection_survival(self, person, did_die_from_infection):
        ...
        with open(self.file_name, "a") as file:
            if did_die_from_infection:
                file.write("This person died. \n"
            else:
                file.write("This person survived \n"
        pass
    ...
    def log_time_step(self, time_step_number):
        ...
        ## Thanks Jamie Mccroy for this part
        ## https://github.com/jamiejamiebobamie/Herd_Immunity/blob/master/Herd_Immunity_Project/logger.py
        ## Line 76
